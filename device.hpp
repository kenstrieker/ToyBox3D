...
namespace engine {
	...
	// struct for bundled queue indices
	...
	private:
		...
		bool isDeviceSuitable(VkPhysicalDevice deviceInstance);
		...
		SwapChainSupportDetails querySwapchainSupport(VkPhysicalDevice deviceInstance);
