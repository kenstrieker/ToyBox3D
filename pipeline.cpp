...
namespace engine {
	...
	PipelineConfigInfo pipeline::defaultPipelineConfigInfo(uint32_t width, uint32_t height) {
		...
		// rasterization stage for breaking up our geometry into fragments for each pixel our triangle overlaps
		...
		// multisampling stage for handling the edges of geometry
		...
		// color blending stage for controlling how we combine colors in the frame buffer
